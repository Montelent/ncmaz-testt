	...
	return (
		...
		>
			<div className="mb-14 flex-shrink-0 lg:mb-0 lg:mr-10 lg:w-2/5">
				<span className="mb-3 block text-xs font-medium uppercase tracking-wider text-neutral-600 dark:text-neutral-300">
					Supercharge your planning powers
				</span>
				<h2 className="mt-3 text-3xl font-semibold sm:text-4xl">
					Become an author and share your great stories
				</h2>
				<span className="mt-8 block text-neutral-600 dark:text-neutral-300">
